...
export default class BallNode extends cc.Component {
    ...
    protected onEnable(): void {
        cc.tween(this.node).to(0.2, { scale: 1.4 }).to(0.2, { scale: 0.8 }).union().repeatForever().start();
        this.schedule(this.moving, 0.4);
        EventMgr.Instance.Register(EventId.googleAdsEnd, () => {this.btnGoogleAd.om});
    }
