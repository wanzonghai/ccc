...
{
public:
    CanvasRenderingContext2DImpl1() : _DC(nullptr)
    , _bmp(nullptr)
    ...
    void restoreContext()
    {
        ...
        if (0 == ret)
        {
            SE_LOGD("CanvasRenderingContext2DImpl1 restore context failed.\n");
        }
    }
    ...
    cocos2d::Size measureText(const std::string& text)
    {
        ...
        //SE_LOGD("CanvasRenderingContext2DImpl1::measureText: %s, %d, %d\n", text.c_str(), size.cx, size.cy);
