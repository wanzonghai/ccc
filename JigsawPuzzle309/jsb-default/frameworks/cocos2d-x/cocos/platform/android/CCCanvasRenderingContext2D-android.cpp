...
#define JCLS_CANVASIMPL  "org/cocos2dx/lib/CanvasRenderingContext2DImpl1"
#endif
...
class CanvasRenderingContext2DImpl1
{
public:
    CanvasRenderingContext2DImpl1()
    {
...
#define CLAMP(V, HI) std::min( (V), (HI) )
    void unMultiplyAlpha(unsigned char* ptr, ssize_t size)
    {
        ...
        // please refer CanvasRenderingContext2DImpl1::recreateBuffer(float w, float h)
        // in CanvasRenderingContext2DImpl1.java
...
, __height(height)
{
    ...
    _impl = new CanvasRenderingContext2DImpl1();
