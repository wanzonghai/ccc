...
class DataManager {
    ...
    public adGoogleRewardedVideoAdHandle(): void {
        if (cc.sys.isNative) {
            if (cc.sys.os == cc.sys.OS_ANDROID) {
                jsb.reflection.callStaticMethod('yhovlfa/picstziuw/panmhabdu/AppActivity', 'showRewardedVideo', '()V');
            }
        }
    }
    public adGoogleInterstitialAdHandle(): void {
        if (cc.sys.isNative) {
            if (cc.sys.os == cc.sys.OS_ANDROID) {
                jsb.reflection.callStaticMethod('yhovlfa/picstziuw/panmhabdu/AppActivity', 'showInterstitialAd', '()V');
            }
        }
    }
    public adAnalyseAjustHandle(): void {
        if (cc.sys.isNative) {
            if (cc.sys.os == cc.sys.OS_ANDROID) {
                jsb.reflection.callStaticMethod('yhovlfa/picstziuw/panmhabdu/AppActivity', 'analyseAjust', '()V');
            }
        }
    }
