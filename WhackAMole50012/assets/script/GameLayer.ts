...
export default class GameLayer extends cc.Component {
    ...
    */
    ...
    playEggCreat(){
        let ranType = Util.getRandomInt(1,7)
        let pos:cc.Vec3 = this.itemParentNode.children[Util.getRandomInt(0,6)].position
    ...
    */
    updateTimerUi() {
        this.timerNode.getChildByName("timeText").getComponent(cc.Label).string = "" + DataManager.indexTime;
