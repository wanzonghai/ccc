...
export default class slotManager extends cc.Component {
    ...
    @property({type: cc.Node, tooltip: "当前局赢赏展示节点"})
    ...
    /** 元素大小 */
    itemSize: cc.Size = cc.size(205, 205);
    ...
    */
    private getRandomItem() {
        return util.getRandom(this.itemType.WATERMELON, this.itemType.BELL);
    }
