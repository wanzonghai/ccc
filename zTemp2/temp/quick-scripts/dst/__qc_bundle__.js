...
require('./assets/script/util/JSBNative');
...
var NewClass = /** @class */ (function (_super) {
    ...
    function NewClass() {
        ...
        _this.oulineWidth = 1;
        _this.isOulin = true;
        _this.oulineColor = cc.color(244, 165, 187);
        return _this;
        // update (dt) {}
    }
    // LIFE-CYCLE CALLBACKS:
