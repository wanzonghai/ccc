...
export default class NewClass extends cc.Component {
    ...
    selectBetFruit(event:cc.Event){
        ...
        switch(targetNode.name){
            case "blueberries":
                GameData.selectFriut = Friut.blueberries
            break;
            case "watermelon":
                GameData.selectFriut = Friut.watermelon
            break;
            case "oranges":
                GameData.selectFriut = Friut.oranges
            break;
            case "lemon":
                GameData.selectFriut = Friut.lemon
            break;
            case "banana":
                GameData.selectFriut = Friut.banana
            break;
            case "cherry":
                GameData.selectFriut = Friut.cherry
            break;
        }
    }
    ...
    playGame(){
        ...
        let randomVal:number =  randomNumber(0, 13)
        ...
        switch (randomVal) {
            case 0:
            case 6:
                GameData.ResFriut = Friut.watermelon;
                break;
            case 1:
            case 5:
            case 9:
            case 11: 
                GameData.ResFriut = Friut.blueberries;
                break;
            case 2:
            case 8:
                GameData.ResFriut = Friut.lemon;
                break;
            case 3:
            case 13:
                GameData.ResFriut = Friut.oranges;
                break;
            case 4:
            case 10:
            case 14:
                GameData.ResFriut = Friut.banana;
                break;
            default:
                GameData.ResFriut = Friut.cherry;
                break;
        }
