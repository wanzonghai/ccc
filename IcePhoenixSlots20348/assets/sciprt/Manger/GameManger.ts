...
export default class NewClass extends cc.Component {
    ...
    selectBetFruit(event:cc.Event){
        ...
        switch(targetNode.name){
            ...
            break;
            case "Apple":
                GameData.selectFriut = Friut.Apple
            break;
            case "SmallBell":
                GameData.selectFriut = Friut.SmallBell
            break;
        }
    }
    ...
    playGame(){
        ...
        let randomVal:number =  randomNumber(0, 15)
        ...
        switch (randomVal) {
            ...
            case 8:
            case 10:
                GameData.ResFriut = Friut.SmallBell;
                break;
            case 1:
            case 11:
            case 14:
