System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, Button, Component, Label, ResolutionPolicy, Sprite, _decorator, find, view, director, Appic, Until, RecycleScroll, ScrollItem, _dec, _class, _crd, ccclass, property, HallScene;
  ...
  function _reportPossibleCrUseOfRecycleScroll(extras) {
    _reporterNs.report("RecycleScroll", "../commons/uiComponent/RecycleScroll", _context.meta, extras);
  }
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      RecycleScroll = _unresolved_4.default;
    }, function (_unresolved_5) {
      ScrollItem = _unresolved_5.ScrollItem;
    }],
    execute: function () {
      _crd = true;
      ...
      __checkObsolete__(['Node', 'Button', 'Component', 'Label', 'ResolutionPolicy', 'Sprite', '_decorator', 'find', 'view', 'Event', 'director']);
      ...
      _export("default", HallScene = (_dec = ccclass('HallScene'), _dec(_class = class HallScene extends Component {
        ...
        initView() {
          ...
          this.itemScroll = (_this$layer_mid$getCh8 = this.layer_mid.getChildByName('ScrollView')) == null ? void 0 : _this$layer_mid$getCh8.getComponent(_crd && RecycleScroll === void 0 ? (_reportPossibleCrUseOfRecycleScroll({
            error: Error()
          }), RecycleScroll) : RecycleScroll);
          this.itemScroll.onItemRender = this.onItemRender.bind(this);
          this.itemScroll.onItemClicked = this.onItemRender.bind(this);
        }
...
//# sourceMappingURL=c05428ec8d3c6c86e471eeb1e69c189e03a8aab1.js.map