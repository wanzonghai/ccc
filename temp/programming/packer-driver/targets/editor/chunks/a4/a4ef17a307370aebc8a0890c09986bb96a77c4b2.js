System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, Button, Component, Label, ResolutionPolicy, Sprite, _decorator, find, view, director, ScrollView, instantiate, Prefab, UITransform, SpriteFrame, Appic, Until, GameMgr, _dec, _class, _crd, ccclass, property, HallScene;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['Node', 'Button', 'Component', 'Label', 'ResolutionPolicy', 'Sprite', '_decorator', 'find', 'view', 'Event', 'director', 'log', 'ScrollView', 'instantiate', 'Prefab', 'UITransform', 'SpriteFrame']);
      ...
      _export("default", HallScene = (_dec = ccclass('HallScene'), _dec(_class = class HallScene extends Component {
        ...
        async loadRes() {
          ...
          await (_crd && Appic === void 0 ? (_reportPossibleCrUseOfAppic({
            error: Error()
          }), Appic) : Appic).DAM.loadDir(this.node, 'texture/hall', SpriteFrame, resSpriteFrams => {
            (_crd && Appic === void 0 ? (_reportPossibleCrUseOfAppic({
              error: Error()
            }), Appic) : Appic).DAM.load(this.node, 'prefab/hall/ItemPass', Prefab, resPre => {
        ...
        updateScrollView(resPre, resSpriteFrams) {
          let itemPassPre = resPre;

          for (let index = 0; index < 5; index++) {
            let itemPaa = instantiate(itemPassPre);
            let keyStr = '';
            ...
            itemPaa.getComponent(Sprite).spriteFrame = (_crd && GameMgr === void 0 ? (_reportPossibleCrUseOfGameMgr({
              error: Error()
            }), GameMgr) : GameMgr).getItemOfArr(keyStr, resSpriteFrams);
...
//# sourceMappingURL=a4ef17a307370aebc8a0890c09986bb96a77c4b2.js.map