  ...
  return {
    ...
    execute: function () {
      ...
      _export("default", DynamicAssetMgr = class DynamicAssetMgr extends (_crd && Singleton === void 0 ? (_reportPossibleCrUseOfSingleton({
        ...
        releaseBundleResOnce($releasetype, $bundleName, $isRemoveBundle = true, $resName, $resType) {
          // 释放在AB包中的单个资源
          let bundle = assetManager.getBundle($bundleName);
        ...
        extracted(asset, nodeId) {
          let assetArray = this._assetMap.get(nodeId);
...
//# sourceMappingURL=06e91d62a192d81b90d0d4560fee8bed90dba712.js.map