System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, Button, Component, Label, ResolutionPolicy, Sprite, _decorator, find, view, director, log, ScrollView, instantiate, Appic, Until, ScrollItem, _dec, _class, _crd, ccclass, property, HallScene;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['Node', 'Button', 'Component', 'Label', 'ResolutionPolicy', 'Sprite', '_decorator', 'find', 'view', 'Event', 'director', 'log', 'ScrollView', 'instantiate']);
        ...
        loadRes() {
          ...
          return _asyncToGenerator(function* () {
            ...
            (_crd && Appic === void 0 ? (_reportPossibleCrUseOfAppic({
              error: Error()
            }), Appic) : Appic).DAM.load(_this.node, "");

            for (var index = 0; index < 6; index++) {
              var itemPaa = instantiate();

              _this.itemScroll.content.addChild();
            }
          })();
        }
...
//# sourceMappingURL=ff9347ca3de266625c43dc7c374b6761260368dd.js.map