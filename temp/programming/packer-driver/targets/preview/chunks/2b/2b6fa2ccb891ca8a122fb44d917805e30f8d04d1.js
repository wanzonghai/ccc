      ...
      _export("default", HallScene = (_dec = ccclass('HallScene'), _dec(_class = class HallScene extends Component {
        ...
        loadRes() {
          ...
          return _asyncToGenerator(function* () {
            ...
            yield (_crd && Appic === void 0 ? (_reportPossibleCrUseOfAppic({
              error: Error()
            }), Appic) : Appic).DAM.loadDir(_this.node, 'texture/hall', SpriteFrame, resSpriteFrams => {
              (_crd && Appic === void 0 ? (_reportPossibleCrUseOfAppic({
                error: Error()
              }), Appic) : Appic).DAM.load(_this.node, 'prefab/hall/ItemPass', Prefab, resPre => {
                _this.updateScrollView(resPre, resSpriteFrams);
              });
            });
          })();
        }
...
//# sourceMappingURL=2b6fa2ccb891ca8a122fb44d917805e30f8d04d1.js.map