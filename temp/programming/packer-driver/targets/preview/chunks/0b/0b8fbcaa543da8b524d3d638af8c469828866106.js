    ...
    execute: function () {
      ...
      _export("LoginScene", LoginScene = (_dec = ccclass('LoginScene'), _dec(_class = class LoginScene extends Component {
        ...
        loadData() {
          ...
          return _asyncToGenerator(function* () {
            _this2.isCanLogin = false;
            _this2.userData = JSON.parse(sys.localStorage.getItem('userData'));
            _this2.btn_guest.node.active = !(_this2.userData && _this2.userData.user.loginData.is_guest && _this2.userData.user.loginData.is_guest == 1);

            if (_this2.userData) {
              _this2.isCanLogin = true;
              (_crd && Appic === void 0 ? (_reportPossibleCrUseOfAppic({
                error: Error()
              }), Appic) : Appic).gameMg.loginInfo = _this2.userData;
...
//# sourceMappingURL=0b8fbcaa543da8b524d3d638af8c469828866106.js.map